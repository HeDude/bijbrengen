...
<div class="container">
    <div class="row">
		...
		$file_uploadsv= ini_get('file_uploads');
		$session_auto_start = ini_get('session_auto_start');
		
		$curl = extension_loaded('curl');

		$mcrypt_encrypt = function_exists('mcrypt_encrypt');
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ol>
						...
						echo "register_globals = " . $register_globals . "<br />";
						echo "magic_quotes_gpc = " . $magic_quotes_gpc . "<br />";
						echo "file_uploadsv = " . $file_uploadsv . "<br />";
						echo "session_auto_start = " . $session_auto_start . "<br />";
						echo "curl = " . $curl . "<br />";
						echo "mcrypt_encrypt = " . $mcrypt_encrypt . "<br />";
						echo "zlib = " . $zlib . "<br />";
                        ?>
                    </ol>
                </div>
